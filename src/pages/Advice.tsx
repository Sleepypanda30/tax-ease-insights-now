...
import { BarChart, Calendar, EuroSign } from "lucide-react";
...
const Advice = () => {
  ...
  return (
    <Layout>
      <div className="mb-4">
        <h1 className="text-2xl font-bold text-white">Tax Insights</h1>
        ...
        <TabsContent value="insights" className="space-y-4">
          <div className="bg-taxgreen-light p-4 rounded-lg mb-4">
            <div className="flex items-center mb-2">
              <EuroSign className="h-5 w-5 text-taxgreen mr-2" />
